...
const AIFormulatorPage = () => {
  return (
    <>
      <Helmet>
        <title>AI Formulator — Personalized Skincare Routine | SKINLABS</title>
        <meta
          name="description"
          content="Get a dermatologist-grade, personalized skincare routine generated by AI from your unique skin profile and selfie. Delivered as a downloadable PDF report."
        />
        <link rel="canonical" href="https://skinlabs.co.za/ai-formulator" />
        <meta property="og:title" content="AI Formulator — Personalized Skincare Routine | SKINLABS" />
        <meta

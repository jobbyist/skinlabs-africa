  ...
  return (
    <>
      <Helmet>
        ...
        {pageNum > 1 && <link rel="prev" href={pageNum === 2 ? "https://skinlabs.co.za/reviews" : `https://skinlabs.co.za/reviews/page/${pageNum - 1}`} />}
              ...
              <section id="shelf-showdown" className="border-b border-border bg-background py-16">
                <div className="container mx-auto px-4">
                  <div className="mb-8 flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
                    ...
                    <Link to="/compare" className="inline-flex items-center gap-2 font-medium text-primary hover:underline shrink-0">
                      All comparisons

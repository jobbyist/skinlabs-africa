  ...
  <>
    <Helmet>
      ...
      <script type="application/ld+json">{JSON.stringify({
        ...
        "@type": "CollectionPage",
        name: "Shelf Showdown",
        description: "Head-to-head South African skincare product comparisons.",
        url: "https://skinlabs.co.za/compare",
      })}</script>
    </Helmet>
      ...
      <main className="pt-24 pb-20">
        <section className="container mx-auto px-4">
          ...
          {comparisonArticles.length === 0 && (
            <p className="py-16 text-center text-muted-foreground">No comparisons published yet. Check back soon.</p>
          )}
        </section>
      </main>
      <Footer />

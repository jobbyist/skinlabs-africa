        ...
        <main className="pt-20 pb-20">
          <section className="container mx-auto px-4">
            <div className="mx-auto mb-8 max-w-2xl text-center">
              ...
              <h1 className="mb-3 font-heading text-3xl font-bold leading-tight text-foreground md:text-5xl">
              ...
              {pagedShowdowns.map((item) =>
                "bodyMarkdown" in item ? (
                  <Link
                    ...
                    className="group flex flex-col overflow-hidden rounded-3xl border border-border bg-card transition-colors hover:border-foreground/30 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
                  >
                    <img
                      src={item.thumbnail.url}
                      alt={item.thumbnail.alt}
                      loading="lazy"
                      className="h-48 w-full object-cover transition-transform duration-500 motion-safe:group-hover:scale-105"
                    />
                    <div className="flex flex-1 flex-col p-6">
                      <span className="mb-2 inline-flex w-fit items-center gap-1 rounded-full bg-muted px-2.5 py-1 text-[11px] font-semibold uppercase tracking-normal text-foreground">
                        {item.saContext}
                      </span>
                  ...
                  >
                    <div className="relative">
                      ...
                      />
                      <span className="absolute left-3 top-3 rounded-full bg-foreground px-2.5 py-1 text-[11px] font-semibold uppercase tracking-normal text-background">
                        Coming soon
                      </span>
                    </div>
                    <div className="flex flex-1 flex-col p-6">
                      ...
                      <p className="mt-2 flex-1 text-sm leading-relaxed text-muted-foreground">{item.dek}</p>
                      <span className="mt-4 inline-flex items-center gap-1 text-sm font-medium text-foreground">
                        View details <ArrowRight className="h-3.5 w-3.5 transition-transform motion-safe:group-hover:translate-x-0.5" aria-hidden="true" />
                      </span>
                    </div>
                  </Link>
                ),

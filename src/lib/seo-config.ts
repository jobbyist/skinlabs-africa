...
export const pageSeo: Record<string, PageSeo> = {
  ...
  aiFormulator: { title: `AI Skincare Routine Builder for South Africa | ${BRAND}`, description: "Build a personalised skincare routine based on your skin profile, climate, budget and goals with SkinLabs® AI-powered skincare technology.", canonicalPath: "/ai-formulator" },

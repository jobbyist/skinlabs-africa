...
export const pageSeo: Record<string, PageSeo> = {
  ...
  pricing: { title: `SkinLabs® Membership | Personalised Skincare Intelligence`, description: "Join SkinLabs® for personalised skincare intelligence, AI-powered routines, product recommendations, skin tracking and exclusive member benefits. Glow Explorer free; Insider from R79/month.", canonicalPath: "/pricing" },

...
export const searchablePages: SearchablePage[] = [
  ...
  { title: "Smart Routines", description: "A living AM and PM routine that adapts to your skin, the season and your shelf — coming soon to members", href: "/routines", keywords: "smart routines am pm coming soon" },

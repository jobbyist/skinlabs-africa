...
export const searchablePages: SearchablePage[] = [
  ...
  { title: "Smart Routines", description: "Your skincare routine, finally built around you — a living AM and PM routine powered by Advanced SKYNN AI that adapts to your skin, the season, your budget and your shelf", href: "/routines", keywords: "smart routines am pm personalised personalized dynamic seasonal budget advanced analysis skynn ai" },

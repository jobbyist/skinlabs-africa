...
export const faqEntries: FAQEntry[] = [
  // ---------------------------------------------------------------- About --
  {
    ...
    relatedPages: [
      ...
      { label: "Start your skin analysis", href: "/skynn-ai" },
    ],
    evidence: [],
  ...
  },
  {
    ...
    relatedPages: [{ label: "Start your skin analysis", href: "/skynn-ai" }],
    evidence: [],
    lastReviewed: KNOWLEDGE_HUB_REVIEW_DATE,
    reviewedBy: REVIEWER,
    riskLevel: "moderate",
    geography: "south-africa",
    safetyNote:
      "SKYNN AI gives educational routine guidance, not a diagnosis. See a dermatologist for a specific skin condition, persistent symptoms or before starting active treatment if you're pregnant, breastfeeding or on medication.",
  },
  {
    id: "about-is-free",
  ...
  // ----------------------------------------------------------- Skin Basics --
  {
    ...
    answer:
      "All of them — oily, dry, combination, sensitive and mature. SKYNN AI factors in your specific skin profile plus South African climate conditions before recommending anything, rather than assuming one default skin type.",
  ...
  },
  {
    ...
    answer:
      "SKYNN AI includes a skin analysis quiz that works this out for you in a couple of minutes. Or just pay attention: oily skin feels greasy by midday, dry skin feels tight or flaky, combination has an oily T-zone with normal-to-dry cheeks, and sensitive skin reacts easily — stinging, redness or itching — to new products.",
    category: "skin-basics",
    tags: ["skin type", "self assessment"],
    relatedQuestions: ["skin-basics-types", "about-ai-formulator-works"],
    relatedPages: [{ label: "Take the skin analysis quiz", href: "/skynn-ai" }],
    evidence: [
  ...
  // -------------------------------------------------------------- Concerns --
  {
    ...
    answer:
      "Yes. We lean on evidence-based ingredients — salicylic acid, niacinamide, benzoyl peroxide — all available from South African brands, and SKYNN AI builds a routine around what's actually driving your breakouts. Results typically take 6–8 weeks of consistent use before you can fairly judge whether a routine is working, so give it time before switching everything.",
    category: "concerns",
  ...
  // -------------------------------------------------------------- Routines --
  {
    ...
    relatedPages: [{ label: "Build your routine with SKYNN AI", href: "/skynn-ai" }],
    evidence: [
  ...
  // ------------------------------------------------------------- South Africa --
  {
    ...
    answer:
      "SA's climates pull in different directions: coastal humidity calls for lighter products, Highveld dryness calls for richer moisturisers, and seasonally high UV wherever you are makes sunscreen non-negotiable. SKYNN AI factors your location into every recommendation rather than assuming one national climate.",
  ...
  },
  {
    ...
    relatedPages: [{ label: "Start your skin analysis", href: "/skynn-ai" }, { label: "Compare all plan details", href: "/pricing" }],
    evidence: [],
    lastReviewed: KNOWLEDGE_HUB_REVIEW_DATE,
    reviewedBy: REVIEWER,
    riskLevel: "low",

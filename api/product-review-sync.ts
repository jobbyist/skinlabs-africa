...
async function generateReview(sourceText: string, apiKey: string, model: string): Promise<GeneratedReviewFields> {
  ...
  return {
    ...
    skin_type_match: Array.isArray(parsed.skin_type_match) ? parsed.skin_type_match.slice(0, 5) : [],
      ...
      seo_intro: parsed.seo_intro,
      review_body: parsed.review_body,
      key_ingredients_structured: parsed.key_ingredients_structured || [],
      skin_types: parsed.skin_types || [],
      skin_concerns: parsed.skin_concerns || [],
      faq: parsed.faq || [],
      related_reviews: parsed.related_reviews || [],
      related_knowledge_articles: parsed.related_knowledge_articles || [],
